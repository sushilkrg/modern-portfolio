...
const projects: Project[] = [
  {
    title: 'Flatmates',
    description:
      'Find and list flatmates in your city. Sign up, post, save listings. Built with MERN stack and hosted on Vercel/Render.',
  ...
  },
  {
    ...
    skills: ['Next.js', 'MongoDB', 'NextAuth', 'TypeScript', 'Resend Email', 'ShadCN'],
  },
  {
    title: 'Micropost',
    description:
  ...
  
  {
    ...
    skills: ["Python",'Django REST Framework', 'React', 'Tailwind CSS', 'PostgreSQL', 'Face Recognition'],
  }
];
        ...
        >
          ...
          >
            ...
            <div className="p-5">
              ...
              <p className="text-sm text-zinc-700 dark:text-zinc-300 mb-4">{project.description}</p>
